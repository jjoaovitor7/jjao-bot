        ...
        if (args[0] == null || args[0] == "" || args[0] == " ") {
            ...
            axios
                ...
                .then(function(response) {
                    message.channel.send({
                        embed: {
                            description: ":moneybag: Preço do Bitcoin (em R$)\nR$ " +
            ...
            axios
                ...
                .then(function(response) {
                    message.channel.send({
                        embed: {
                            description: ":moneybag: Preço do Bitcoin (em $)\n$ " +
...
`,
    ...
    ping(client, message) {
        ...
        message.channel.send(
            ...
            .addFields({ name: "Ping", value: `${ping}ms`, inline: true }, { name: "API Ping", value: `${pingbot}ms`, inline: true })
        );
    }
